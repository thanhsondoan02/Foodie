  ...
  return (
    <article className="welcome-section">
      <section className="section-2-info flex-container flex-column txt-center pop-font">
        <motion.img
          src={PizzaTwo} alt="Pizza Two" className="pizza-two"
        ...
        <motion.img
          ...
          whileInView={{ opacity: 1, translateX: 100 }}
          transition={{ duration: 5 }} />
        <h2 className="txt-white">Welcome to <span>Pizza Time</span> restaurant</h2>
        <p>
      ...
      <LazyLoadImage
        ...
        src={img375}
        srcSet={`${img375} 375w, ${img700} 700w, ${img1440} 1440w`}
        sizes="(min-width: 1440px) 1440px, (min-width: 700px) 700px, 375px"
        alt="Pizza Time restaurant interior with people at the table and the staff serving the customers" />
    </article>
  )
}
